...
print("Reason: The state q1 has two transitions on the symbol 'b' (to both q2 and q3)")
...
fa_visual.render('finite_automaton', format='png', cleanup=True)
print("\nFA visualization saved as 'finite_automaton.png'")

if not is_dfa:
    dfa_visual = dfa.visualize()
    dfa_visual.render('deterministic_finite_automaton', format='png', cleanup=True)
    print("DFA visualization saved as 'deterministic_finite_automaton.png'")